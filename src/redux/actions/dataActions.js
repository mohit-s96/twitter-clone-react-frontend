import {SET_PUBLIC_WHINES, LOADING_PUBLIC, SET_PUBLIC_DATA, SET_PUB_ERRORS,
         ONE_WHINE_LOADED, LOAD_ONE_WHINE, POSTED_COMMENT, POSTING_COMMENT,
          LOADING_SUGGESTIONS, SUGGESTIONS_LOADED, SEARCH_LOADING, SEARCH_LOADED, UPDATING_INFO, UPDATED_INFO} from '../types';
...
export const getSearchAutoComplete = (keyword) => dispatch => {
    ...
    axios.post('/userlist', {searchWords: keyword})
         .then(res => {
             dispatch({
                 type: SEARCH_LOADED,
                 payload: res.data
