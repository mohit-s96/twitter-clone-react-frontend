import {SET_ERRORS, SET_USER, CLEAR_ERRORS, LOADING_UI, SET_UNAUTHENTICATED,
...
export const postRewhine = (rewhineAction, flag) => dispatch => {
   if(flag === 'public'){
    ...
    axios.post('/whines', rewhineAction)
         .then(() => {
            console.log('');
         })
         .catch(err => console.log(err));
