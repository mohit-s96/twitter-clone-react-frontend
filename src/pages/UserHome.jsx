     ...
     componentDidMount(){
         const unsub = setInterval(() => {
             if(document.querySelector('.feed-container')){
                 document.querySelector('.feed-container').addEventListener('scroll', e => {
        ...
        let x = (!loading)
         ...
         <div>
             ...
             <div className="feed-container">
                 ...
                 <Feed/>
                {
                    (this.props.user.pagedFetching) ? <div className="single-feed-container" style={{textAlign: 'center', padding: '12px'}}><img src={ajax} alt="ajax"/></div> : null
                }
                {
                    (!this.props.user.moreData) ? <div className="single-feed-container" style={{textAlign: 'center', padding: '12px'}}><b>No more whines to show</b></div> : null
                }
             </div>
